...
| メソッド | ソースコード参照 |
|------|------|
| `loadArwFile` | `CAS/Functions/UfCamera.cs:2708` |
| `GetCameraPosUf` | `CAS/Functions/UfCamera.cs:4602` |
| `calcMeasAreaPv` | `CAS/Functions/UfCamera.cs:5449` |
| `GetCpCabinet` | `CAS/Functions/UfCamera.cs:8733` |
| `CaptureRefPoint` | `CAS/Functions/UfCamera.cs:9416` |
| `ProcRefPoint` | `CAS/Functions/UfCamera.cs:9495` |
| `CalcTrimmingAreaMask` | `CAS/Functions/UfCamera.cs:9765` |
| `StoreCp` | `CAS/Functions/UfCamera.cs:10097` |
| `storeCpRadiator` | `CAS/Functions/UfCamera.cs:10152` |
| `GetFlatImages` | `CAS/Functions/UfCamera.cs:10247` |
